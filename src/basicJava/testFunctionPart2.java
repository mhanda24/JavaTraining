...
public class testFunctionPart2 {
	...
	//	int sum = num1 + num2;
		...
		divisionCalculator(sum2,11);
		System.out.println("sum of two numbers " +a+ " and " +b+ " = " + sum3);
		
		//String b1= ;
		System.out.println( greeting("Richa"));
	...
	public static int divisionCalculator(int number1, int number2) {
